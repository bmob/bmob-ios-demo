...
@protocol BmobSocketIOTransportDelegate <NSObject>
...
@protocol BmobSocketIOTransport <NSObject>

- (id) initWithDelegate:(id <BmobSocketIOTransportDelegate>)delegate;
- (void) open;
- (void) close;
- (BOOL) isReady;
